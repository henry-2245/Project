...
class ShopPage(QDialog):
    ...
    def gotoBasketPage(self):
        ...
        basketPage = BasketPage(self.item_name, self.item_price, self.item_quantity, self.net_price)
...
class BasketPage(QDialog):
    ...
    def __init__(self, item_name, item_price, item_quantity, all_food_price):
        ...
        for i in range(self.amount_of_item):
            ...
            item_name_label[i].setText(self.item_name[i])
            item_price_label[i].setText(str(self.item_price[i] * self.item_quantity[i]) + "฿")
    ...
    def goBackToShopPage(self):
        basketPage = BasketPage(self.item_name, self.item_price, self.item_quantity, self.all_food_price)
